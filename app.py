...
async def main():
    ...
    for industry in industries:
        ...
        #distinction of industry on the basis of retail keyword
        
        #if industry is retail
        if "retail" in industry.lower():
            print("for retail industry !")
            continue    #as it was not working and giving errors
            results_by_models = []
            ...
            #non retail industry service details generated by claude llm
            ...
            if not Path(file_path).is_file() or True:
                ...
                #parsing the data and adding it to database
